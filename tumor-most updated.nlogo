...
patches-own [energy-amount chemokine]
...
to setup-tumors
  create-tumors 1 [setxy pxcor / 2 pycor / 2 ] ; place tumor cells in random areas
  ask tumors [
...
to setup-imm
  create-immunes 3 [setxy -16 -16] ; place tumor cells in bottom L corner
  ask immunes [
...
to tumor-chemokine
 ...
 ; ask tumors
 ; [ if count turtles [color = blue] > 30
 ;   set chemokine chemokine + 2 ] ; drop onto patch
...
to imm-chemokine
    ask immunes
  [ if chemokine > specificity ;ignore unless there is enough
    [turn-toward-chemokine]
